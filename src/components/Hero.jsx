        ...
        <Col md={6} className="">
          ...
          <Row>
            <p className="h3 subtext textDown">
              Where the parties <span className='pop'>pop</span> and the fun never stops!
            </p>
          </Row>
          <Row>
            <Col md={10}>
              ...
              <div className="hero-btn">
                <Button id="herobutton" target="_blank"href="https://www.honeybook.com/widget/floral_pop_co_203712/cf_id/61783908e47c1c07fd82b023">Book Now</Button>
              </div>
            </Col>
          </Row>
        </Col>
